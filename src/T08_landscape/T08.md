...
- Less lines of code (see Table)

#### The bad

- No type definition in view
- No browser refresh after change.
...
- Advanced tooling (hot-reload, etc)
- Type definition
  - Still need to take care of frontend/backend interface.

#### The bad

- More (too much) technical knowledge required.
  - Need two separate frameworks.
- Complicated
- More code to write
