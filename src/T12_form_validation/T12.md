...
![bg right:70% contain](./img/back.png)

---

# Frontend

![bg right:70% contain](./img/front.png)
...
- Try `VITE_URL_DATA=/api/users_wrong` in `.env`
- Try using form - no validation.

---

## We want

- Advanced data valiation (string, date, email, password confirmation, ... )
- Give useful error message.
- Sanitize output from backend.
- Reuse logic in front and backend
