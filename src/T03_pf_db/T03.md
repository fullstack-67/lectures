...
- Enable type information when intereating with database.
- Allow you to write schema file and can be commited to repository.
  - Good for communication or documentation
- Nice Tooling
